...
func InitConfig(){
	...
	configFileName := fmt.Sprintf("16-amqp/rabbitmq/01-gin-web/%s-pro.yaml", configFilePrefix)
	if debug {
		configFileName = fmt.Sprintf("16-amqp/rabbitmq/01-gin-web/%s-debug.yaml", configFilePrefix)
	}
