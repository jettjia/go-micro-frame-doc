...
var file_gateway_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x32, 0x4e, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12,
	0x43, 0x0a, 0x04, 0x45, 0x63, 0x68, 0x6f, 0x12, 0x0e, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x0e, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67,
...
var file_gateway_proto_depIdxs = []int32{
	0, // 0: Gateway.Echo:input_type -> StringMessage
	0, // 1: Gateway.Echo:output_type -> StringMessage
...
func (c *gatewayClient) Echo(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/Gateway/Echo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
