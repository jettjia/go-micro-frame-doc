...
func InitConfig(){
	...
	configFileName := fmt.Sprintf("14-sentinel/02-gin-sentinel/%s-pro.yaml", configFilePrefix)
	if debug {
		configFileName = fmt.Sprintf("14-sentinel/02-gin-sentinel/%s-debug.yaml", configFilePrefix)
	}
